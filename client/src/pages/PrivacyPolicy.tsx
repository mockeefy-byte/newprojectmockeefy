    ...
    return (
        <div className="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
            ...
            <div className="prose prose-blue max-w-none text-gray-600 space-y-6">
                ...
                <h2 className="text-xl font-semibold text-gray-800 mt-6 mb-3">Sharing</h2>
                <p>
                ...
                <h2 className="text-xl font-semibold text-gray-800 mt-6 mb-3">Security Precautions</h2>
                <p>
                ...
                <h2 className="text-xl font-semibold text-gray-800 mt-6 mb-3">Data Deletion and Retention</h2>
                <p>
                ...
                <h2 className="text-xl font-semibold text-gray-800 mt-6 mb-3">Consent</h2>
                <p>
                ...
                <h2 className="text-xl font-semibold text-gray-800 mt-6 mb-3">Grievance Officer</h2>
                <div className="bg-gray-50 p-4 rounded-lg border border-gray-100">
                    <p className="mb-1"><strong>Insert Name of the Office:</strong> Support</p>
                    <p className="mb-1"><strong>Designation:</strong> Grievance Officer</p>
                    <p className="mb-1"><strong>Insert Name and Address of the Company:</strong> Mockeefy, East Vanniyar Street, Kk Nagar West Chennai</p>
                    <p className="mb-1"><strong>Contact us:</strong> support@mockeefy.com</p>
