  ...
  return (
    <div className="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-blue max-w-none text-gray-600 space-y-6">
        ...
        <p>
          This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://www.mockeefy.com/ ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
        </p>
        <p>
          The Platform is owned by Mockeefy with its registered office at East Vanniyar Street, Kk Nagar West Chennai, a company incorporated under the Companies Act, 1956 (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').
        </p>
        <p>
        ...
        <ul className="list-decimal pl-6 space-y-4">
          ...
          <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Chennai.</li>
