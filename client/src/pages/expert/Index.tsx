...
function StatCard({ title, value, icon, iconBg, trendText, trendColor, trendHighlight, onClick }: StatCardProps) {
  return (
    <button
      type="button"
      onClick={onClick}
      className={`group text-left bg-white rounded-2xl p-6 border border-slate-200 shadow-sm hover:shadow-md hover:border-blue-400 hover:ring-1 hover:ring-blue-400 transition-all duration-300 flex flex-col min-w-0 h-[160px] ${onClick ? 'cursor-pointer' : ''}`}
    >
