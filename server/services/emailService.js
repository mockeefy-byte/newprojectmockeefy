...
export const notifyWithdrawalSuccess = async (expertEmail, expertName, amount, accountLast4) => {
    const html = `
        <div style="font-family: Arial, sans-serif; padding: 20px; color: #333;">
            <h2 style="color: #059669;">Withdrawal Successful</h2>
            ...
            <div style="background: #ecfdf5; padding: 15px; border-radius: 8px; margin: 20px 0; border: 1px solid #a7f3d0;">
                ...
                <p><strong>Bank Account:</strong> ending in ${accountLast4}</p>
                <p><strong>Status:</strong> Success</p>
            </div>

            <p>The amount should reflect in your registered bank account shortly. Thank you for your continued partnership.</p>
            <br>
            <p>Best regards,<br>Mockeefy Team</p>
        </div>
    `;
    ...
    return sendEmail({
        to: expertEmail,
        subject: `Withdrawal Processed Successfully - Mockeefy`,
        html
    });
};
